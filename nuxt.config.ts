...
export default defineNuxtConfig({
	...
	app: {
		head: {
			title: 'Lucia Accounts Ranks Followage',
			htmlAttrs: { lang: 'en' },
			link: [
				{ rel: 'canonical', href: 'https://ranks.mishu.dev' },
			...
			meta: [
				...
				{
					name: 'description',
					content: 'Lucia Accounts Ranks Followage'
				},
				{
					name: 'viewport',
				...
				{ name: 'identifier-URL', content: 'https://ranks.mishu.dev' },
				...
				{ name: 'shortlink', content: 'https://ranks.mishu.dev' },
				{
					name: 'subject',
					content: 'Lucia Accounts Ranks Followage'
				},
				...
				{ name: 'url', content: 'https://ranks.mishu.dev' },
				{
				...
				{ property: 'og:title', content: 'Lucia Accounts Ranks Followage' },
				{ property: 'og:type', content: 'website' },
				{ property: 'og:url', content: 'https://ranks.mishu.dev' },
